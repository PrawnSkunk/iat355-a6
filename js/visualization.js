...
(function () {
    ...
    function generatePlot(title, data_array, column_array) {
        ...
        svgChart.selectAll(".dot")
            ...
            .attr("class", function (f, i) {
                ...
                if (selectedStatus == "Prohibited") return "dot dot-prohibited";
                if (selectedTerminatedYear > 0 && column_array[i] >= selectedTerminatedYear) return "dot dot-terminated";
                if (selectedYear == 0) return "dot";
                return (column_array[i] >= selectedYear) ? "dot dot-after" : "dot dot-before";
            })
            .attr("cx", function (d) {
                return xChart(d);
            })
        ...
        svgChart.append("g")
            ...
            .selectAll("text")
            .attr("y", function (d, i) {
                return -heightChart + 10 + yChart(d)
            })
            .attr("x", 0)
            .attr("dy", ".35em");
            ...
            .on("click", function (d) {
                ...
                d3.select("#" + d.id)
                    ...
                    .html(function (d) {
                        ...
                        generatePlot(title, data_array, range);
